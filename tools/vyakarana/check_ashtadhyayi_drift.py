...
TRACKED = [
    ("fit", "phitsutra", "data/vedanga/vyakarana/phitsutra/data.json"),
    ("ganapath", "ganapatha", "data/vedanga/vyakarana/ganapatha/data.json"),
    ("linganushasanam", "linganushasana", "data/vedanga/vyakarana/linganushasana/data.json"),
    ("unaadi", "unadi", "data/vedanga/vyakarana/unadi/data.json"),
]

# The two direct-from-site citations with no recorded commit -- content-diffed
# by sutra reference instead of by commit.
UNTRACKED = [
    ("sutraani/bhashya.txt", "data/vedanga/vyakarana/ashtadhyayi/mahabhashya_patanjali/data.json"),
    ("sutraani/vasu_english.txt", "data/vedanga/vyakarana/ashtadhyayi/vasu/data.json"),
]
