#!/usr/bin/env python3
"""Build guru-parampara/data/uttaradi_app_profiles.json -- a companion
...
DB = os.path.join(ROOT, "sources/uttaradi_matha/panchanga/2024-2027/um_app_seed.db")
OUT = os.path.join(ROOT, "guru-parampara/data/uttaradi_app_profiles.json")
...
def main():
    ...
    out = {
        "_note": [
            ...
            "verified, and sources/uttaradi_matha/panchanga/2024-2027/source-manifest.json "
