...
This is the interpretation step that RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md
...
(RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.7's VALIDATE mode / sec.10's
...
Writes: data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/krama_kramahetu_rules.json
"""
import json
...
SUTRA_DATA_PATH = (
    REPO_ROOT / "data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/data.json"
)
OUT_PATH = (
    REPO_ROOT
    / "data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/krama_kramahetu_rules.json"
)
...
def main():
    ...
    out = {
        ...
        "note": (
            ...
            "(RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.7/sec.10). The "
        ...
        "source_sutras": "data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/data.json",
        "items": rules,
    }
