...
Input: data/vedas/rigveda/shakala_shakha/samhita/mandala_01/data.json,
...
SAMHITA_PATH = ROOT / "data/vedas/rigveda/shakala_shakha/samhita/mandala_01/data.json"
OLD_OUTPUT_PATH = ROOT / "data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/krama_generated_output.json"
OUT_PATH = ROOT / "data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/krama_regenerated_output.json"
        ...
        for a_idx, ardharca in enumerate(item["ardharcas"]):
            ...
            ardharca["chain_reconstruction"] = {
                ...
                "note": "" if matched else "The phonology engine's own chained reconstruction of this "
                                            ...
                                            "(see RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.6.6 for "
...
def main():
    ...
    out = {
        ...
        "pada_samhita_source": "data/vedas/rigveda/shakala_shakha/samhita/mandala_01/data.json",
        "counts": counts,
