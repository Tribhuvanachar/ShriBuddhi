...
3. Outside patala 10-11, that same-index correspondence is NOT verified
   ...
   RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.4a.1 (patala 2: 82 vs 41
...
Updates: data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/data.json
"""
import html
import json
import re
...
DATA_PATH = (
    REPO_ROOT
    / "data/vedanga/shiksha/pratishakhya/rigveda_pratishakhya/data.json"
)
...
# the module docstring and RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.4c
...
# (11 Sep 2026) -- see RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.6.10 for
