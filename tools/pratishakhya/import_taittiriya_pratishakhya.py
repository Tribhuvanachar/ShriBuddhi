...
RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.4a.1). Catalog page:
...
Writes: data/vedanga/shiksha/pratishakhya/taittiriya_pratishakhya/data.json
"""
import json
import re
import sys
...
OUT_PATH = (
    REPO_ROOT / "data/vedanga/shiksha/pratishakhya/taittiriya_pratishakhya/data.json"
)
