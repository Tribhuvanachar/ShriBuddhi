...
RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md relies on: the total sutra
...
DATA_PATH = os.path.join(
    REPO, "data", "vedanga", "shiksha", "pratishakhya",
...
class RigvedaPratishakhyaData(unittest.TestCase):
    ...
    def test_verified_krama_sutras(self):
        # Hand-verified against the source (RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md
    ...
    def test_hand_verified_uncertain_resolutions_cover_patala_2_up_to_42(self):
        ...
        # RV_PRATISHAKHYA_KRAMA_ARCHITECTURE.md sec.6.10). Every
